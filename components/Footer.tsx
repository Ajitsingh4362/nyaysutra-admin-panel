...
const quickLinks = [['/','Home'],['/about','About Us'],['/team','Advocate Team'],['/practice-areas','Practice Areas'],['/courts','Courts & Jurisdiction'],['/students','Students & Internship'],['/gallery','Gallery'],['/blog','Blog'],['/contact','Contact'],['/verify','Verify Certificate']];
